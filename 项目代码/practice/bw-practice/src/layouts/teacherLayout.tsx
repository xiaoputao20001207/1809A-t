...
const TeacherLayout: React.FC = (props) => {
  return (
    <Layout>
      ...
      <Header>
        <img
          src="http://111.203.59.61:8060/static/img/w_bw.172a76e5.png"
          alt=""
        />
      ...
      <Footer>
        <div className="bw_bottom">
          <div className="b_b_detail">
            <div className="b_b_left">
              <div className="bw_img">
                <img
                  src="http://111.203.59.61:8060/static/img/bottom_logo.c8aa9859.png"
                  alt=""
                />
              </div>
            ...
            <div className="b_b_middle">
              ...
              <div className="middle_two middle">
                <div className="middle_title">八维文化</div>
                <div className="href_a">
            ...
            <div className="b_b_right">
              <img
                src="http://111.203.59.61:8060/static/img/wechat.e60a83ec.png"
                alt=""
              />
          ...
          <div className="b_b_sign">
            京公网安备 11010802031438号 © Copyright 2020. 八维教育版权所有 |
            京ICP备12008262号-12
          </div>
        </div>
      </Footer>
