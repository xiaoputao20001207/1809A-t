...
import { ISkilldairn, Addpro,TrainingSyllabusList, ProjectResourcesList } from '@/utils/interface';
...
const addProject: React.FC<IRouteComponentProps> = ({ history,location }) => {
    ...
    <Tabs defaultActiveKey="1" className={styles.Tabs}>
       <TabPane tab="实训大纲" key="1" >
                <Layout >
                    ...
                    <Content style={{width:"1100px", padding: '0 24px', minHeight: 280 }}>
                        <Button>保存</Button>
                ...
                <Layout >
                    <Content >
                        <Layout >
                            ...
                            <Content style={{width:"800px", padding: '0 24px', minHeight: 280 }}>
  ...
  let id=location.query.id as string;
  useEffect(() => {
    if(versionId){
        ...
        <div className="box_shen">
          ...
          <div className="cww_two">
            <div className="cww_two_one">
             ...
             { versionId||id1?<span>{proSkill.detailList.name}</span>:<input
                    type="text"
                    className="ipt1"
                    placeholder="请输入项目名称"
                    value={name}
                  ...
                  {versionId||id1 ? <span>{proSkill.detailList.version}</span>: (
                    <input
                      type="text"
                      className="ipt2"
                      value={version}
                ...
                <div className="cww_two_two_two">
                 {versionId||id1?<span>{proSkill.detailList.description}</span>:<input
                    type="text"
                    className="ipt7"
                    placeholder="请输入简介"
                    value={description}
                ...
                <div className="cww_two_two_san">
                 ...
                 {versionId||id1?<span>{[proSkill.detailList.labelName,proSkill.detailList.stationName]}</span>:<Cascader
                    options={zhuanye}
               ...
               {versionId||id1?<span>{proSkill.detailList.tradeName}</span>:<Cascader
                    options={hangye}
                ...
                <div className="cww_two_two_si">
                 ...
                 {versionId||id1?<span>{proSkill.detailList.sxType}</span>:<Cascader
                    options={options}
                  ...
                  />}
                  <b>预期总工时</b>{' '}
                {versionId||id1?<span>{proSkill.detailList.subjectTime}</span>:<InputNumber
                    min={1}
                    max={10}
                    defaultValue={3}
                    onChange={onChangegs}
              ...
              <div className="cww_two_san">
                ...
                <div className="cww_two_san_two">
                 {versionId||id1?<span><img src={proSkill.detailList.pictureUrl} alt="" />521</span>:<Upload
                    name="avatar"
                ...
                <div className="cww_two_san_san">
                 ...
                 {versionId||id1?<span>{proSkill.detailList.showUrl}</span>:<input
                    type="text"
                    placeholder="请输入演示地址"
                    className="ipt8"
                    value={shpwUrl}
